...
png(filename = "~/Documents/Stade Rennais/02_Code R/Sankey_22-23/23-10-21_Sankey_Circulaire_5_ans_Bouri_PD.png",
    width = 10000,
    height = 10000)
...
monsoussoustitre = "Le focus est fait en rouge sur les passes décisives de B. Bourigeaud."
